    ...
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //DT3 = stuMealTicket(int.Parse(DropDownList1.SelectedValue));
                //DT4 = volMealTicket(int.Parse(DropDownList1.SelectedValue));
            }
            GridView1.DataSource = DT;
            GridView2.DataSource = DT1;
            GridView3.DataSource = DT2;
            //DetailsView1.DataSource = DT3;
            //DetailsView2.DataSource = DT4;
            GridView1.DataBind();
            GridView2.DataBind();
            GridView3.DataBind();
        ...
        private DataTable volInfo(int EventID)
        {
            ...
            {
                sqlQuery1 = "SELECT EventPersonnel.FirstName + ' ' + EventPersonnel.LastName as VolunteerName, EventPersonnel.ParticipationHistory, EventPersonnel.OrganizationAffiliation, EventPersonnel.MealTicket ";
        ...
        private DataTable stuInfo(int EventID)
        {
            ...
            {
                sqlQuery2 = "SELECT  Student.FirstName + ' ' + Student.LastName as StudentName, Student.ParentAttending, Student.LunchTicket ";
